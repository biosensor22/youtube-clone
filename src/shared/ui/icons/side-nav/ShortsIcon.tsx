...
interface ShortsSVGProps extends React.SVGProps<SVGSVGElement> {
  isActive: string;
  onSwitch?: () => void;
}

export function ShortsIcon({ isActive, ...props }: ShortsSVGProps) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d={
          isActive === urlPaths.shorts
            ? "m13.974 2.052-8 4.7a4 4 0 00.385 7.097l.942.423-1.327.78a4 4 0 004.052 6.897l8-4.7a4.001 4.001 0 00-.384-7.096L16.7 9.73l1.326-.78a4 4 0 10-4.052-6.897ZM10 15V9l5 3-5 3Z"
