    ...
    <div className={`relative flex flex-1 w-full max-w-165 px-1 h-10`}>
      <div className="relative flex-1">
        <div
          onClick={focusRef}
          className={`
            absolute right-0 flex items-center justify-between
            border border-(--border-color) rounded-l-full py-1.25 pl-3
            bg-(--input-bg-color) text-white/70 text-lg cursor-text 
